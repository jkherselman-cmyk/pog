  ...
  el.innerHTML = `
    <header class="site-header">
      <div class="container">
        <a href="${prefix}index.html" class="brand">
          <img src="${prefix}Logo.png" alt="POG African Safaris logo" class="brand-logo">
    ...
    <div id="mobile-menu" class="mobile-menu">
      <div class="mobile-menu-head">
        <span class="brand"><img src="${prefix}Logo.png" alt="" class="brand-logo"><span>POG African Safaris</span></span>
